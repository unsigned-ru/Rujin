...
namespace rujin
{
	...
	{
	public:
		explicit BoxColliderComponent(const glm::vec2& size, bool isStatic = true, const glm::vec2& pivot = { 0.5f, 0.5f }, CollisionLayer collisionLayer = CollisionLayer::Default);
