...
void rujin::Renderer::Initialize() {}
...
void rujin::Renderer::Render() const
{
	...
	sceneManager->OnGui(m_WindowInfo.pWindow);
...
void rujin::Renderer::RenderTexture(const Texture& texture, const Transform& transform, const glm::vec2& pivot, const Rectf* srcRect) const
{
