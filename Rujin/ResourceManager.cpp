...
rujin::ResourceManager::ResourceManager()
{
...
rujin::ResourceManager::~ResourceManager() = default;
void rujin::ResourceManager::Initialize() {}

//TODO: make RAII instead.
std::shared_ptr<rujin::Texture> rujin::ResourceManager::LoadTexture(const std::string& file)
{
